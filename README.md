Eu criei este repositório para compartilhar os projetos que desenvolvi durante a minha formação como Python Developer. Durante o curso, aprendi desde os conceitos básicos da sintaxe da linguagem até a integração com APIs e a construção de projetos práticos utilizando os principais frameworks, como Flask e Django.
